...
<script type="text/javascript" src="<?php echo $this->base ?>/assets/plugins/datepicker/custom-datepicker.js?v=<?php echo time(); ?>"></script>
...
<script type="text/javascript" src="<?php echo $this->base ?>/assets/plugins/chartjs/chart.min.js"></script>
