...
<body>
	<div>
		...
		<div class="text-center underlined bold" style="padding-top:10px">CASH DISBURSEMENT VOUCHER</div>
	</div>
	...
	<div style="padding-top:20px; font-size:14px">
		<table class="table">
			<tr>
				...
				<td class="italic" colspan="2">Recievied from DHVTSU MPC</td>
			</tr>
			<tr class="small-pad">
				<td style="border-bottom:1px solid #000"></td>
				<td class="padL" style="width:12%">Amount:</td>
				<td class="italic bold"><?php echo 'PHP ' . number_format($entry['AccountingEntry']['amount'], 2) ?></td>
			</tr>
			<tr class="small-pad">
				<td></td>
				<td class="padL">CV #:</td>
				<td class="italic bold" style="width:50px"><?php echo $entry['AccountingEntry']['code'] ?></td>
			</tr>
		</table>
		...
		<table class="table">
			<tr class="small-pad">
				...
				<td class="italic bold"><?php echo $entry['AccountingEntry']['name'] ?></td>
			</tr>
			<tr class="small-pad">
				<td style="width:50%;border-bottom:1px solid #000"></td>
				<td class="padL" >Date:</td>
				<td class="italic bold"><?php echo date('F d, Y', strtotime($entry['AccountingEntry']['date'])) ?></td>
			</tr>
