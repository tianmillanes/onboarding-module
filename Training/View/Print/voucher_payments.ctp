...
<body>
  	<div class="row">
  		<div class="col-md-12">
  			<div class="text-center" style="margin:5px 0px;"><strong><?php echo $this->Global->Settings('cooperative_name') ?></strong></div>
  			<div class="text-center uppercase" style="padding:10px 0px 10px 0px"><strong>CASH RECEIPT VOUCHER</strong></div>
  ...
  <?php foreach($entries as $entry) :?>  
    ...
    <!--<hr style="display:block;page-break-before: always;">-->
</body>
</html>
