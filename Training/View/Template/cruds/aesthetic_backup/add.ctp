...
<div class="crud-body">
  <div class="crud-card">
    <div class="crud-title-wrapper">
      <h2 class="crud-title"><i class="fa fa-user-plus"></i> Add Personal Record</h2>
    </div>
    ...
    <div class="row">
      <div class="col-md-3 pull-right">
        <button class="crud-btn-add btn-block" ng-click="save()" style="justify-content: center;"><i class="fa fa-save"></i> Save Record</button>
      </div>
      <div class="col-md-3 pull-right">
