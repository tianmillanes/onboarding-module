          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <div class="date-picker-wrapper">
                <input type="text" class="date-input form-control" id="edit_permission_date" ng-model="adata.date" placeholder="Select Date">
                <button type="button" class="date-picker-toggle" tabindex="-1">📅</button>
                <div class="date-picker-container" id="edit_permission_date_picker"></div>
              </div>
            </div>
          </div>
          <div class="col-md-12">
