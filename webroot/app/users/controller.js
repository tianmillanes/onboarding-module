...
app.controller('UsersAddController', function($scope, User, Select) {
  ...
  setTimeout(function() {
    if (document.getElementById('add_permission_date')) {
      new CustomDatePicker('add_permission_date', { format: 'MM/DD/YYYY' });
    }
    if (document.getElementById('edit_permission_date')) {
      new CustomDatePicker('edit_permission_date', { format: 'MM/DD/YYYY' });
    }
  }, 100);
